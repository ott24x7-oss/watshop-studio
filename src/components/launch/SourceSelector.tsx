		...
		return (
			...
			>
				<div className="text-center">
					<div className="animate-spin duration-500 rounded-[50%] h-6 w-6 border-2 border-b-transparent border-[#34C77B] mx-auto mb-2" />
		...
		<div className={`min-h-screen flex flex-col ${styles.glassContainer}`}>
			...
			<div className="p-3 justify-center flex gap-2">
				...
				<Button
					...
					className="px-5 py-1 text-xs bg-[#34C77B] text-white active:scale-95 transition-transform duration-150 hover:bg-[#34C77B]/80 disabled:opacity-30 disabled:bg-zinc-700 rounded-full"
				>
					{tc("actions.share")}
				</Button>
			</div>
