		...
		<div className="flex-[2] min-w-0 bg-[#09090b] border border-white/5 rounded-2xl flex flex-col shadow-xl h-full overflow-hidden">
			<div className="flex-1 overflow-y-auto custom-scrollbar p-4 pb-0">
					...
					<div className="flex items-center justify-between mb-3">
						...
						<div className="flex items-center gap-2">
							{zoomEnabled && selectedZoomDepth && (
								<span className="text-[10px] uppercase tracking-wider font-medium text-[#34C77B] bg-[#34C77B]/10 px-2 py-0.5 rounded-full">
							...
							return (
								<Button
									...
									className={cn(
										...
										isActive
											? "border-[#34C77B] bg-[#34C77B] text-white shadow-[#34C77B]/20"
				...
				>
					{hasWebcam && (
						...
						>
							<AccordionTrigger className="py-2.5 hover:no-underline">
								<div className="flex items-center gap-2">
									<Sparkles className="w-4 h-4 text-[#34C77B]" />
												...
												<button
													...
													className={cn(
														...
														webcamMaskShape === shape.value
															? "bg-[#34C77B] border-[#34C77B] text-white"
							...
							<div className="grid grid-cols-2 gap-2 mb-3">
								<div className="flex items-center justify-between p-2 rounded-lg bg-white/5 border border-white/5">
									...
									<Switch
										...
										className="data-[state=checked]:bg-[#34C77B] scale-90"
									/>
								</div>
							</div>
							...
							<div className="grid grid-cols-2 gap-2">
								<div className="p-2 rounded-lg bg-white/5 border border-white/5">
									...
									<Slider
										...
										max={1}
										step={0.01}
										className="w-full [&_[role=slider]]:bg-[#34C77B] [&_[role=slider]]:border-[#34C77B] [&_[role=slider]]:h-3 [&_[role=slider]]:w-3"
									/>
								</div>
								<div className="p-2 rounded-lg bg-white/5 border border-white/5">
									<div className="flex items-center justify-between mb-1">
					...
					>
						<AccordionTrigger className="py-2.5 hover:no-underline">
							<div className="flex items-center gap-2">
								<Palette className="w-4 h-4 text-[#34C77B]" />
						...
						<AccordionContent className="pb-3">
							<Tabs defaultValue="image" className="w-full">
								<TabsList className="mb-2 bg-white/5 border border-white/5 p-0.5 w-full grid grid-cols-3 h-7 rounded-lg">
									<TabsTrigger
										value="image"
										className="data-[state=active]:bg-[#34C77B] data-[state=active]:text-white text-slate-400 text-[10px] py-1 rounded-md transition-all"
									>
										{t("background.image")}
									</TabsTrigger>
									<TabsTrigger
								...
								<div className="max-h-[min(200px,25vh)] overflow-y-auto custom-scrollbar">
									<TabsContent value="image" className="mt-0 space-y-2">
										...
										<Button
											...
											variant="outline"
											className="w-full gap-2 bg-white/5 text-slate-200 border-white/10 hover:bg-[#34C77B] hover:text-white hover:border-[#34C77B] transition-all h-7 text-[10px]"
										>
												...
												return (
													<div
														...
														className={cn(
															...
															isSelected
																? "border-[#34C77B] ring-1 ring-[#34C77B]/30"
																: "border-white/10 hover:border-[#34C77B]/40 opacity-80 hover:opacity-100 bg-white/5",
														)}
														style={{
						...
						<div className="mt-6 space-y-4">
								...
								{[
									...
									<div key={field} className="flex flex-col gap-1">
										...
										<input
											...
											className="w-[90px] h-8 rounded-md border border-white/10 bg-white/5 px-2 text-xs text-slate-200 outline-none focus:border-[#34C77B]/50 focus:ring-1 focus:ring-[#34C77B]/30 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
										/>
									</div>
								))}
								...
								<div className="flex flex-col gap-1">
									...
									<div className="flex items-center gap-1.5">
										<select
											...
											className="h-8 rounded-md border border-white/10 bg-[#1a1a1f] px-2 text-xs text-slate-200 outline-none focus:border-[#34C77B]/50 cursor-pointer"
										>
										...
										<button
											...
											className={cn(
												...
												cropAspectLocked
													? "border-[#34C77B]/50 bg-[#34C77B]/10 text-[#34C77B]"
							...
							<div className="flex justify-end">
								<Button
									...
									size="lg"
									className="bg-[#34C77B] hover:bg-[#34C77B]/90 text-white"
								>
									{t("crop.done")}
								</Button>
							</div>
			...
			<div className="flex-shrink-0 p-4 pt-3 border-t border-white/5 bg-[#09090b]">
						...
						<div className="flex items-center justify-between">
							...
							<div className="flex items-center gap-2">
								...
								<Switch
									...
									className="data-[state=checked]:bg-[#34C77B] scale-75"
								/>
							</div>
						</div>
					</div>
				...
				<Button
					...
					size="lg"
					onClick={onExport}
					className="w-full py-5 text-sm font-semibold flex items-center justify-center gap-2 bg-[#34C77B] text-white rounded-xl shadow-lg shadow-[#34C77B]/20 hover:bg-[#34C77B]/90 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200"
				>
					<Download className="w-4 h-4" />
				...
				<div className="flex gap-2 mt-3">
					...
					>
						<Bug className="w-3 h-3 text-[#34C77B]" />
						{t("links.reportBug")}
					</button>
					<button
						type="button"
						onClick={() => {
							window.electronAPI?.openExternalUrl("https://watshop.in");
						}}
						className="flex-1 flex items-center justify-center gap-1.5 text-[10px] text-slate-500 hover:text-slate-300 py-1.5 transition-colors"
					>
