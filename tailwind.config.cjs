...
module.exports = {
	...
	theme: {
		extend: {
			...
			boxShadow: {
				"hud-bar": "0 2px 16px rgba(0, 0, 0, 0.25), 0 0 40px rgba(52, 199, 123, 0.10)",
				"mic-panel": "0 2px 12px rgba(0, 0, 0, 0.2), 0 0 30px rgba(52, 199, 123, 0.08)",
			},
			borderRadius: {
				lg: "var(--radius)",
